...
class SitePagesControllerTest < ActionController::TestCase
  ...
  test "should create site_page" do
    assert_difference('SitePage.count') do
      post :create, site_page: { content: @site_page.content, description: @site_page.description, key: @site_page.key, keywords: @site_page.keywords, site_id: @site_page.site_id, title: @site_page.title }
    end
  ...
  test "should update site_page" do
    patch :update, id: @site_page, site_page: { content: @site_page.content, description: @site_page.description, key: @site_page.key, keywords: @site_page.keywords, site_id: @site_page.site_id, title: @site_page.title }
    assert_redirected_to site_page_path(assigns(:site_page))
  end
